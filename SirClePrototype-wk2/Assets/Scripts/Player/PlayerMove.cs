...
public class PlayerMove : MonoBehaviour 
{
	...
	public Vector3 secondJumpForce =  new Vector3(0, 0, 0);		//2nd
	public Vector3 thirdJumpForce =  new Vector3(0, 0, 0);		//3rd
...
//					}
	...
	{
		if(col.gameObject.name == "PowerUp-JumpHigher")
		{
			Destroy(col.gameObject);
			powerUpJump = true;
			jumpForce = jumpForce * 1.15f;

//			// Assigns a material named "Assets/Resources/Red" to the object.
//			Material redMat = Resources.Load("Red", typeof(Material)) as Material;
//			gameObject.GetComponent<Renderer>().material = redMat;
		}

		if(col.gameObject.name == "PowerUp-WaterWalk")
		{
			GameObject water1;
			water1 = GameObject.Find("Level Piece - Water");
			water1.GetComponent<Collider>().enabled = true;

			Destroy(col.gameObject);
			jumpForce = new Vector3(0, 13, 0);
			
//			// Assigns a material named "Assets/Resources/Blue" to the object.
